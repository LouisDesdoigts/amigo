...
#     def evolve_ramp(self, illuminance, z_point, ngroups, return_bleed=True):
#         # evolve_ramp(illum, bias, self.ngroups, return_bleed=True)
...
#         # charge_ramp, bleed = conv_rnn(bias, illuminance, self.gain_model, return_bleed)

#         # Interpolate the ramps to the number of groups
#         if return_bleed:
#             return self.norm * interp_ramp(charge_ramp, ngroups), bleed
#         return self.norm * interp_ramp(charge_ramp, ngroups)
